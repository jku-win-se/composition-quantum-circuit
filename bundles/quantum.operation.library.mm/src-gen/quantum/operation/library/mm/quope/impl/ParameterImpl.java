 ...
 * </p>
 * <ul>
 *   <li>{@link quantum.operation.library.mm.quope.impl.ParameterImpl#getTheta <em>Theta</em>}</li>
 *   <li>{@link quantum.operation.library.mm.quope.impl.ParameterImpl#getPhi <em>Phi</em>}</li>
 *   <li>{@link quantum.operation.library.mm.quope.impl.ParameterImpl#getLambda <em>Lambda</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterImpl extends MinimalEObjectImpl.Container implements Parameter {
	...
	protected EClass eStaticClass() {
		return QuantumOpePackage.Literals.PARAMETER;
	}
	...
	public void setTheta(Boolean newTheta) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QuantumOpePackage.PARAMETER__THETA, oldTheta, theta));
	}
	...
	public void setPhi(Boolean newPhi) {
		...
		phi = newPhi;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QuantumOpePackage.PARAMETER__PHI, oldPhi, phi));
	}
	...
	public void setLambda(Boolean newLambda) {
		...
		lambda = newLambda;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QuantumOpePackage.PARAMETER__LAMBDA, oldLambda,
					lambda));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case QuantumOpePackage.PARAMETER__THETA:
			return getTheta();
		case QuantumOpePackage.PARAMETER__PHI:
			return getPhi();
		case QuantumOpePackage.PARAMETER__LAMBDA:
			return getLambda();
		}
