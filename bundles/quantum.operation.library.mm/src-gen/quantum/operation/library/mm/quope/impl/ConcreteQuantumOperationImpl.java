...
import quantum.operation.library.mm.quope.Parameter;
 ...
 * </p>
 * <ul>
 *   <li>{@link quantum.operation.library.mm.quope.impl.ConcreteQuantumOperationImpl#getType <em>Type</em>}</li>
 *   <li>{@link quantum.operation.library.mm.quope.impl.ConcreteQuantumOperationImpl#getReverseConcreteQuantumOperation <em>Reverse Concrete Quantum Operation</em>}</li>
 *   <li>{@link quantum.operation.library.mm.quope.impl.ConcreteQuantumOperationImpl#getAbbreviation <em>Abbreviation</em>}</li>
 *   <li>{@link quantum.operation.library.mm.quope.impl.ConcreteQuantumOperationImpl#getPaletteIconPath <em>Palette Icon Path</em>}</li>
 *   <li>{@link quantum.operation.library.mm.quope.impl.ConcreteQuantumOperationImpl#getStyleIconPath <em>Style Icon Path</em>}</li>
 *   <li>{@link quantum.operation.library.mm.quope.impl.ConcreteQuantumOperationImpl#getParameter <em>Parameter</em>}</li>
 *   <li>{@link quantum.operation.library.mm.quope.impl.ConcreteQuantumOperationImpl#getFixedQuantumOperation <em>Fixed Quantum Operation</em>}</li>
 *   <li>{@link quantum.operation.library.mm.quope.impl.ConcreteQuantumOperationImpl#getReversible <em>Reversible</em>}</li>
 * </ul>
 *
 * @generated
 */
