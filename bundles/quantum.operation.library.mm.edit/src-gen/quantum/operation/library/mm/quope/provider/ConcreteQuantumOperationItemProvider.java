/**
 */
package quantum.operation.library.mm.quope.provider;
...
/**
 * This is the item provider adapter for a {@link quantum.operation.library.mm.quope.ConcreteQuantumOperation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConcreteQuantumOperationItemProvider extends NamedElementItemProvider {
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_ConcreteQuantumOperation_type_feature"),
	...
	protected void addAbbreviationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_ConcreteQuantumOperation_abbreviation_feature",
						"_UI_ConcreteQuantumOperation_type"),
				QuantumOpePackage.Literals.CONCRETE_QUANTUM_OPERATION__ABBREVIATION, true, false, false,
	...
	protected void addPaletteIconPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_ConcreteQuantumOperation_paletteIconPath_feature",
						"_UI_ConcreteQuantumOperation_type"),
				QuantumOpePackage.Literals.CONCRETE_QUANTUM_OPERATION__PALETTE_ICON_PATH, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QuantumOpePackage.Literals.CONCRETE_QUANTUM_OPERATION__PARAMETER);
			childrenFeatures.add(QuantumOpePackage.Literals.CONCRETE_QUANTUM_OPERATION__FIXED_QUANTUM_OPERATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(QuantumOpePackage.Literals.CONCRETE_QUANTUM_OPERATION__PARAMETER,
				QuantumOpeFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add(
				createChildParameter(QuantumOpePackage.Literals.CONCRETE_QUANTUM_OPERATION__FIXED_QUANTUM_OPERATION,
						QuantumOpeFactory.eINSTANCE.createFixedQuantumOperation()));
	}
