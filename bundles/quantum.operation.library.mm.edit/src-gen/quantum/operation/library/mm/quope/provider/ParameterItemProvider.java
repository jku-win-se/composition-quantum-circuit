...
/**
 * This is the item provider adapter for a {@link quantum.operation.library.mm.quope.Parameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Parameter_theta_feature",
								"_UI_Parameter_type"),
						QuantumOpePackage.Literals.PARAMETER__THETA, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Parameter_phi_feature",
								"_UI_Parameter_type"),
						QuantumOpePackage.Literals.PARAMETER__PHI, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Parameter_lambda_feature",
								"_UI_Parameter_type"),
						QuantumOpePackage.Literals.PARAMETER__LAMBDA, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
