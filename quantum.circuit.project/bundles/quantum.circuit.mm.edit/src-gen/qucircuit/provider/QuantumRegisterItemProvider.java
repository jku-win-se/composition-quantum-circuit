 ...
 * @generated
 */
public class QuantumRegisterItemProvider extends NamedElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QuCircuitPackage.Literals.QUANTUM_REGISTER__QUBITS);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_QuantumRegister_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(QuCircuitPackage.Literals.QUANTUM_REGISTER__QUBITS,
				QuCircuitFactory.eINSTANCE.createQubit()));
	}
