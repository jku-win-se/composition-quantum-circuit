...
public class QuCircuitParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, QuCircuitGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getIndexIntAccess().getGroup(), "rule__IndexInt__Group__0");
			builder.put(grammarAccess.getIndexIntAccess().getGroup_1(), "rule__IndexInt__Group_1__0");
			builder.put(grammarAccess.getIndexRangeAccess().getGroup(), "rule__IndexRange__Group__0");
			builder.put(grammarAccess.getIndexRangeAccess().getGroup_1(), "rule__IndexRange__Group_1__0");
			...
			builder.put(grammarAccess.getIndexIntAccess().getRegisterAssignment_1_0(), "rule__IndexInt__RegisterAssignment_1_0");
			builder.put(grammarAccess.getIndexIntAccess().getIndexAssignment_2(), "rule__IndexInt__IndexAssignment_2");
			builder.put(grammarAccess.getIndexRangeAccess().getRegisterAssignment_1_0(), "rule__IndexRange__RegisterAssignment_1_0");
			builder.put(grammarAccess.getIndexRangeAccess().getBeginAssignment_2(), "rule__IndexRange__BeginAssignment_2");
			builder.put(grammarAccess.getIndexRangeAccess().getEndAssignment_4(), "rule__IndexRange__EndAssignment_4");
		}
	}
