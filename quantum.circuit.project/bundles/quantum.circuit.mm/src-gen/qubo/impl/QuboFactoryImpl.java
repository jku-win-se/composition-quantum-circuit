...
public class QuboFactoryImpl extends EFactoryImpl implements QuboFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case QuboPackage.QUBO: return createQubo();
			case QuboPackage.MATRIX: return createMatrix();
			case QuboPackage.ROW: return createRow();
			case QuboPackage.COLUMN: return createColumn();
			default:
