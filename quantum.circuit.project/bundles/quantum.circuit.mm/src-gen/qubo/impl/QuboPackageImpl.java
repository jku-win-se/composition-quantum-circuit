...
import qucircuit.impl.QucircuitPackageImpl;
...
public class QuboPackageImpl extends EPackageImpl implements QuboPackage {
	...
	public static QuboPackage init() {
		if (isInited) return (QuboPackage)EPackage.Registry.INSTANCE.getEPackage(QuboPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredQuboPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		QuboPackageImpl theQuboPackage = registeredQuboPackage instanceof QuboPackageImpl ? (QuboPackageImpl)registeredQuboPackage : new QuboPackageImpl();
		...
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(QucircuitPackage.eNS_URI);
		QucircuitPackageImpl theQucircuitPackage = (QucircuitPackageImpl)(registeredPackage instanceof QucircuitPackageImpl ? registeredPackage : QucircuitPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		initEReference(getQubo_Matrix(), this.getMatrix(), null, "matrix", null, 0, 1, Qubo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getColumn_Value(), ecorePackage.getEDoubleObject(), "value", null, 0, 1, Column.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
