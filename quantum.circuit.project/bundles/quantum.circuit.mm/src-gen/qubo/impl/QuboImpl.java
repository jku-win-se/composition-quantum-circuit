...
public class QuboImpl extends NamedElementImpl implements Qubo {
	...
	public NotificationChain basicSetMatrix(Matrix newMatrix, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, QuboPackage.QUBO__MATRIX, oldMatrix, newMatrix);
	...
	public void setMatrix(Matrix newMatrix) {
		if (newMatrix != matrix) {
			...
			if (matrix != null)
				msgs = ((InternalEObject)matrix).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - QuboPackage.QUBO__MATRIX, null, msgs);
			if (newMatrix != null)
				msgs = ((InternalEObject)newMatrix).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - QuboPackage.QUBO__MATRIX, null, msgs);
