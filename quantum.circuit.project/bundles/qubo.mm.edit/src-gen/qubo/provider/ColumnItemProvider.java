...
/**
 * This is the item provider adapter for a {@link qubo.Column} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ColumnItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Column_value_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Column_value_feature", "_UI_Column_type"),
						QuboPackage.Literals.COLUMN__VALUE, true, false, false,
	...
	public String getText(Object object) {
		Double labelValue = ((Column) object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		case QuboPackage.COLUMN__VALUE:
	...
	public ResourceLocator getResourceLocator() {
		return QuboEditPlugin.INSTANCE;
	}
