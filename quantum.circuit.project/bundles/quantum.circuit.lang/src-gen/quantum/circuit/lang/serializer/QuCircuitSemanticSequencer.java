...
public class QuCircuitSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == QucircuitPackage.eINSTANCE)
			...
			case QucircuitPackage.QUANTUM_REGISTER:
				if (rule == grammarAccess.getQuantumRegisterRule()) {
					sequence_QuantumRegister(context, (QuantumRegister) semanticObject); 
					return; 
				}
				else if (rule == grammarAccess.getSimplifiedQuantumRegisterRule()) {
					sequence_SimplifiedQuantumRegister(context, (QuantumRegister) semanticObject); 
					return; 
				}
				else break;
	 ...
	 * </pre>
	 */
	protected void sequence_SimplifiedQuantumRegister(ISerializationContext context, QuantumRegister semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, QucircuitPackage.Literals.QUANTUM_REGISTER__NUMBER_OF_QUBITS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, QucircuitPackage.Literals.QUANTUM_REGISTER__NUMBER_OF_QUBITS));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getSimplifiedQuantumRegisterAccess().getNumberOfQubitsINTTerminalRuleCall_2_0(), semanticObject.getNumberOfQubits());
		feeder.finish();
	}
