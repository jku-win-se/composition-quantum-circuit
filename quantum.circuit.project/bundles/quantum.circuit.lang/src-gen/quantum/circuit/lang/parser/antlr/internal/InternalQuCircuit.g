...
entryRuleSimplifiedQuantumRegister returns [EObject current=null]:
	...
	{ $current=$iv_ruleSimplifiedQuantumRegister.current; }
	EOF;

// Rule SimplifiedQuantumRegister
ruleSimplifiedQuantumRegister returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		(
			(
				lv_numberOfQubits_2_0=RULE_INT
				{
