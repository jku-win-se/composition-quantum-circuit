...
@after {
	...
	(
		...
		{
			$current = $this_IndexInt_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_IndexRange_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;

// Entry rule entryRuleIndexInt
entryRuleIndexInt returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getIndexIntRule()); }
	iv_ruleIndexInt=ruleIndexInt
	{ $current=$iv_ruleIndexInt.current; }
	EOF;

// Rule IndexInt
ruleIndexInt returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleIndexRange
entryRuleIndexRange returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getIndexRangeRule()); }
	iv_ruleIndexRange=ruleIndexRange
	{ $current=$iv_ruleIndexRange.current; }
	EOF;

// Rule IndexRange
ruleIndexRange returns [EObject current=null]
@init {
	enterRule();
}
@after {
