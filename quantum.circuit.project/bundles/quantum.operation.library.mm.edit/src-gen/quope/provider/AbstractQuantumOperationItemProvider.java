...
/**
 * This is the item provider adapter for a {@link quope.AbstractQuantumOperation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractQuantumOperationItemProvider extends NamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AbstractQuantumOperationItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addPaletteIconPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_AbstractQuantumOperation_paletteIconPath_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_AbstractQuantumOperation_paletteIconPath_feature",
						"_UI_AbstractQuantumOperation_type"),
				QuopePackage.Literals.ABSTRACT_QUANTUM_OPERATION__PALETTE_ICON_PATH, true, false, false,
	...
	protected void addStyleIconPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_AbstractQuantumOperation_styleIconPath_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_AbstractQuantumOperation_styleIconPath_feature",
						"_UI_AbstractQuantumOperation_type"),
				QuopePackage.Literals.ABSTRACT_QUANTUM_OPERATION__STYLE_ICON_PATH, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addReversiblePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_AbstractQuantumOperation_reversible_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_AbstractQuantumOperation_reversible_feature", "_UI_AbstractQuantumOperation_type"),
						QuopePackage.Literals.ABSTRACT_QUANTUM_OPERATION__REVERSIBLE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_AbstractQuantumOperation_type_feature"),
	...
	public String getText(Object object) {
		String label = ((AbstractQuantumOperation) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_AbstractQuantumOperation_type")
				: getString("_UI_AbstractQuantumOperation_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractQuantumOperation.class)) {
