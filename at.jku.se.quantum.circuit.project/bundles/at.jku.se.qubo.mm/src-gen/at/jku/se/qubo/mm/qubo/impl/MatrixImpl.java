 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.se.qubo.mm.qubo.impl.MatrixImpl#getRows <em>Rows</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MatrixImpl extends MinimalEObjectImpl.Container implements Matrix {
	...
	protected EClass eStaticClass() {
		return QuboPackage.Literals.MATRIX;
	}
	...
	public EList<Row> getRows() {
		if (rows == null) {
			rows = new EObjectContainmentEList<Row>(Row.class, this, QuboPackage.MATRIX__ROWS);
		}
		return rows;
	}
