...
import at.jku.se.quantum.operation.definition.api.IGeneralOperationType;
	...
	private void executeExtension(EList<ConcreteQuantumOperation> operations, HashMap<ConcreteQuantumOperation, String> reverseGate, 
		...
		ISafeRunnable runnable = new ISafeRunnable() {
            ...
            public void run() throws Exception {
            	ConcreteQuantumOperation ope = QuantumOpeFactoryImpl.init().createConcreteQuantumOperation();
